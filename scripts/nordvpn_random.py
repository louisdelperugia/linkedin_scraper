...
def nordvpn_random():
    try:
        continuous_mode = input(
            "Would you like to have this script continuously run and log in to random servers at random time intervals? [y/n]: ").lower()
        if continuous_mode == "y":
            ...
            print(
                "This script will only run this one time.  If you want to choose another server at random then you will need to run the script again.")
